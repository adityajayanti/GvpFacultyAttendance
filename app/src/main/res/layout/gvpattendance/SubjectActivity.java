...
public class SubjectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        private void loadProducts(){
            StringRequest stringRequest = new StringRequest(Request.Method.POST, com.example.aditya.gvpattendance.Constansts.TimeTableURL,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                contentsAdapter = new com.example.aditya.gvpattendance.ContentsAdapter(com.example.aditya.gvpattendance.SubjectActivity.this, contentsList,1);
                                ...
                                contentsAdapter.setItemClickListener(new com.example.aditya.gvpattendance.ContentsAdapter.OnItemClickListener() {
                                    ...
                                    public void onItemClick(int position) {
                                        if(aNO.equals("Week")){
                                            ...
                                            Intent intent = new Intent(getApplicationContext(), com.example.aditya.gvpattendance.AttendanceActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            ...
            case R.id.backto:
                if(aNO.equals("Week")) {
                    startActivity(new Intent(getApplicationContext(), com.example.aditya.gvpattendance.WeekActivity.class));
