...
public class Adjust_Attendance extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if((dept.equals("Dept") || sem.equals("Sem")) || hr.equals("Hour")|| sub.equals("Subject")||((dept.equals("MSC") && sem.equals("5") )) ||((dept.equals("MSC") && sem.equals("6") ) )) {
                    ...
                    contentsAdapter = new com.example.aditya.gvpattendance.ContentsAdapter(com.example.aditya.gvpattendance.Adjust_Attendance.this, contentsList, 3);
    ...
    private void loadData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, com.example.aditya.gvpattendance.Constansts.MySubjectURL,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("fid", SharedPrefManager.getInstance(com.example.aditya.gvpattendance.Adjust_Attendance.this).getFid().toString());
                return params;
            }
        };
    ...
    public void toast(final Context context, final String text) {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent = new Intent(com.example.aditya.gvpattendance.Adjust_Attendance.this,AttendanceMenu.class);
    ...
    private void insertAtt(){
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    //constants
                    URL url = new URL(com.example.aditya.gvpattendance.Constansts.InsertAttendanceURL);
                    JSONObject jGroup ;
                    ...
                    for (int i = 0; i < contentsList.size(); i++) {
                        ...
                        try {
                            ...
                            jGroup.put("FID", SharedPrefManager.getInstance(com.example.aditya.gvpattendance.Adjust_Attendance.this).getFid().toString());
                    ...
                    if(conn.getResponseCode()==201 || conn.getResponseCode()==200) {
                        ...
                        toast(com.example.aditya.gvpattendance.Adjust_Attendance.this,jsonReply);
    ...
    private void loadProducts() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, com.example.aditya.gvpattendance.Constansts.StudentAttendanceURL,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
