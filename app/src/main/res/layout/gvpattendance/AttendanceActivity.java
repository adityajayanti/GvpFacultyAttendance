    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                contentsAdapter = new com.example.aditya.gvpattendance.ContentsAdapter(com.example.aditya.gvpattendance.AttendanceActivity.this, contentsList, 3);
    ...
    public void toast(final Context context, final String text) {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent = new Intent(com.example.aditya.gvpattendance.AttendanceActivity.this,AttendanceMenu.class);
                ...
                try {
                    ...
                    for (int i = 0; i < contentsList.size(); i++) {
                        ...
                        try {
                            ...
                            jGroup.put("FID", SharedPrefManager.getInstance(com.example.aditya.gvpattendance.AttendanceActivity.this).getFid().toString());
                    ...
                    if(conn.getResponseCode()==201 || conn.getResponseCode()==200) {
                        ...
                        toast(com.example.aditya.gvpattendance.AttendanceActivity.this,jsonReply);
