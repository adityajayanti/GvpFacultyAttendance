    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                contentsAdapter = new ContentsAdapter(CtvAttendance.this, contentsList, 3);
    ...
    public void toast(final Context context, final String text) {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent = new Intent(CtvAttendance.this, AttendanceMenu.class);
            ...
            public void run() {
                ...
                try {
                    ...
                    for (int i = 0; i < contentsList.size(); i++) {
                        ...
                        for(int j = 0; j<4 ; j++) {
                            try {
                                ...
                                jGroup.put("FID", SharedPrefManager.getInstance(CtvAttendance.this).getFid().toString());
                    ...
                    if(conn.getResponseCode()==201 || conn.getResponseCode()==200) {
                        ...
                        toast(CtvAttendance.this,jsonReply);
